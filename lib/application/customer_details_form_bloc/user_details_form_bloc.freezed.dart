...
// ignore: unused_element
  _InitializeUser initializeUser(EmployeeUser user) {
...
mixin _$UserDetailsFormEv {
  ...
  Result when<Result extends Object>({
    ...
    @required Result initializeUser(EmployeeUser user),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    ...
    Result saveChanges(),
    Result initializeUser(EmployeeUser user),
...
abstract class _InitializeUser implements UserDetailsFormEv {
  const factory _InitializeUser(EmployeeUser user) = _$_InitializeUser;
...
class _$UserDetailsFormStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      user: user == freezed ? _value.user : user as EmployeeUser,
