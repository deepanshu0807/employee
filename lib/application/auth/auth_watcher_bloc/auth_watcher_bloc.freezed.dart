...
mixin _$AuthWatcherEvent {
  ...
  Result when<Result extends Object>({
    ...
    @required Result authReceived(Option<EmployeeUser> userOption),
    @required Result signedOut(EmployeeUser user),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result authCheckRequested(),
    Result authReceived(Option<EmployeeUser> userOption),
    Result signedOut(EmployeeUser user),
...
mixin _$AuthWatcherState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result authenticated(EmployeeUser user),
    @required Result unauthenticated(),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result initial(),
    Result authenticated(EmployeeUser user),
